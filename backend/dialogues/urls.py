...
from .views import (
    ...
    DialogueReviewListView, DialogueModerateView, DialogueWithdrawView, MyCommunicationRequestsView,
    DialogueImportShareView,
    DialogueIllustrationCreateView, DialogueIllustrationDetailView, DialogueInlineImageCreateView,
    DialogueResourceProposalListCreateView, DialogueResourceProposalReviewListView,
    DialogueResourceProposalModerateView, DialogueResourceProposalWithdrawView,
    CommentCreateView, CommentUpdateView, CommentReviewListView, CommentApproveView,
    CommentModerateView, CommentWithdrawView,
    LikeToggleView,
...
urlpatterns = [
    ...
    path('communications/mine/', MyCommunicationRequestsView.as_view(), name='my_communication_requests'),
    ...
    path('dialogues/<int:dialogue_id>/resource-proposals/', DialogueResourceProposalListCreateView.as_view(), name='resource_proposal_list_create'),
    path('dialogues/<int:dialogue_id>/inline-images/', DialogueInlineImageCreateView.as_view(), name='inline_image_create'),
    ...
    path('resource-proposals/review/', DialogueResourceProposalReviewListView.as_view(), name='resource_proposal_review_list'),
    path('resource-proposals/<int:pk>/moderate/', DialogueResourceProposalModerateView.as_view(), name='resource_proposal_moderate'),
    path('resource-proposals/<int:pk>/withdraw/', DialogueResourceProposalWithdrawView.as_view(), name='resource_proposal_withdraw'),
    ...
    path('comments/<int:pk>/withdraw/', CommentWithdrawView.as_view(), name='comment_withdraw'),
